                        ...
                        <table class="aatable">
                            ...
                            for($index=0;$index < count($orderData);$index++){
                		        ...
                		        if ($order->get_status() == 'confirmed' || $order->get_status() == 'delivering'){    
                                	...
                                	echo "<td>".$order->get_time()."</td>";
									echo "<td>".$order->get_status()."</td>";
									if($order->get_status() != 'delivering')
									 echo "<td><form  action='deliverOrderController.php' method='post'><input type='hidden' name='oid' value='".$order->get_oid()."'/><input type='submit' value='deliver'/></form>";
                                	echo "</tr>";
								}
                            }
                            ?>                            
