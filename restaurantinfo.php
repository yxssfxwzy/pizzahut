                ...
                <div id="content">
                    <div id="welcome">
                        ...
                        <table class="aatable">
                            ...
                            <?php
                            $restaurantData = getUserRestaurantInfo();
                            ...
                            for($index=0;$index < count($restaurantData);$index++){
                                ...
                                echo "<td><form  action='orderMenuItem.php' method='post'><input type='hidden' name='restaurant_id' value='".$restaurant->get_id()."'/><input type='submit' value='Order'/></form></td>";
                                echo "</tr>";
                            }
                            ?>
                        </table>
